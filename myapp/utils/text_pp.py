...
dir_path = 'PowerPoint-Generator-Python-Project-main\\myapp\\static\\presentations\\'
load_dotenv()
...
def parse_response(response):
    ...
    for slide in slides:
        ...
        if keyword is None:
            keyword = "No keyword provided"  # Default if no keyword is found
...
def create_ppt(slides_content, template_choice, presentation_title, presenter_name, insert_image):
    ...
    prs.save(os.path.join('E:\College\minor\PowerPoint-Generator-Python-Project-main\PowerPoint-Generator-Python-Project-main\myapp\generated', 'generated_presentation.pptx'))
